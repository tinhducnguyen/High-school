...
?>
<div class="banner">
    <center><img src="../assets/img/Ban.PNG"></center>
    <body bgcolor="#CAFFFF">
    <style type="text/css">
        #menu ul{
            margin-left: -5px;
...
<div id="menu" >
    ...
    <p style="font-family:Tahoma;font-weight: bold;text-align: center;font-size: large">TRƯỜNG THPT PHÙ CỪ</p>
    	<ul>
...
<table  border=0 cellpadding5 cellspacing=0 align="center" width="1300">
    <TR>
        ...
        <td  colspan="2" bgcolor="#336699" align="center" style="color:white; height: 30px" >
            Copyright &copy; 2021 Trường THPT Phù Cừ <br>
        </td>
    </tr>
    </td>
    </TR>
