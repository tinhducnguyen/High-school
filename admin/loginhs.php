...
<body>
<div style="margin-top:60px;text-align: center;font-weight: bold;font-size: 25px;font-family: Tahoma ">TRƯỜNG THPT PHÙ CỪ</div>
...
<div style="border: 1px solid #CDCDCD;background-color: #e4e0d8;width: 500px;margin-left: 440px;font-family: Tahoma">
	...
	<li>Đối tượng sử dụng : Học Sinh THPT Phù Cừ.</li>
